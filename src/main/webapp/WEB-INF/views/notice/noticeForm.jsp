...
top:100px;
	...
	div#board-continer{width:800px;margin:0 auto; text-align:center; color:black; 	border-color:black;}
	div#board-continer input{margin-bottom:15px;	border-color:black;}
...
<!--                 <div class="input-group-prepend" style="padding:0px;">
            ...
            <textarea class="form-control" name="boardContent" style="height:260px; border-color:black; " placeholder="내용" required ></textarea>
                 </form>
            <br><br>
