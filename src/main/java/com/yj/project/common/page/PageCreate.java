...
public class PageCreate {
	...
	public String getSearchPageBar(String searchType,String searchForm,int cPage, int numPerPage,int totalCount, String url) {
	      String pageBar="";
	      ...
	      pageBar+="location.href='"+url+"?cPage='+cPage+'&searchType='+$('#searchType').val()+'&searchForm='+$('#searchForm').val();";
	      pageBar+="}";
	      pageBar+="</script>";
