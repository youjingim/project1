...
public class Club {
	...
	private String circle_location;
	
	public Club() {
		// TODO Auto-generated constructor stub
	}

	public Club(int circle_num, String circle_name, String university, int dept_no, String circle_adviser,
			String member_id, String circle_level, String circle_phone, Date circle_enrolldate, String circle_photo,
			String category, String circle_comment, int circle_like, String circle_location) {
		super();
		...
		this.circle_location = circle_location;
	}
	...
	public String getCircle_location() {
		return circle_location;
	}

	public void setCircle_location(String circle_location) {
		this.circle_location = circle_location;
	}

	@Override
	public String toString() {
		return "Club [circle_num=" + circle_num + ", circle_name=" + circle_name + ", university=" + university
				...
				+ circle_comment + ", circle_like=" + circle_like + ", circle_location=" + circle_location + "]";
	}
